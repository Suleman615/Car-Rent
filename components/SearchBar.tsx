...
const SearchBar=()=>{
    ...
    const handleSearch=(e: React.FormEvent<HTMLFormElement>)=>{
        e.preventDefault()
        if(manufacturer===''&& model==='') return alert("PLease Write Something In Search Bar")
    ...
    return(
        <>
            <form action="" onSubmit={handleSearch} className='flex items-center justify-start max-sm:flex-col w-full relative max-sm:gap-4 max-w-3xl'>
